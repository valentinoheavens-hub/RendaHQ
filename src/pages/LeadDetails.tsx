      ...
      <div className="space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div className="ml-auto flex gap-3">
            ...
            <Button className="bg-emerald-600 hover:bg-emerald-700 text-white gap-2" onClick={handleSendProposal}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className={cn(
              ...
              analysis ? "bg-slate-50" : "bg-emerald-50 border-emerald-100"
            )}>
                ...
                {analysis && !isAnalyzing && (
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-emerald-600 rounded-xl">
                      <p className="text-[10px] font-bold text-emerald-200 uppercase tracking-wider mb-1">Next Best Action</p>
                  ...
                  {lead.timeline.map((item, i) => (
                    <div key={i} className="relative">
                      <div className={cn(
                        ...
                        item.type === "call" ? "bg-blue-500" : item.type === "email" ? "bg-emerald-500" : "bg-slate-400"
                      )}>
                  ...
                  <Card className="border-none shadow-sm">
                    <CardContent className="p-6 space-y-4">
                      ...
                      <Textarea
                        ...
                        className="min-h-[280px] resize-none border-slate-200 focus-visible:ring-emerald-500 text-sm leading-relaxed text-slate-700"
